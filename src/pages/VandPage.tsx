...
export default function VandPage() {
  const { factors, vand, addVand, getFactorByKey, deleteRecord } = useData();
  const availableFactors = useMemo(() => getFactorsForCategory(factors, 'vand'), [factors]);
